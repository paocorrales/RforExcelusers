...
![RStudio main screen. Console, environment and Files panels](img/rstudio-principal.png){alt="RStudio main screen. Console, environment and Files panels" fig-align="center" width="1000"}

![RStudio Cloud main screen. Console, environment and Files panels](img/rstudio-cloud-principal.png){alt="RStudio Cloud main screen. Console, environment and Files panels" fig-align="center" width="1000"}
...
![Rmarkdown in the left. Knit document on the rigth](img/markdown-knit.png){alt="Rmarkdown in the left. Knit document on the rigth" fig-align="center" width="1000"}
